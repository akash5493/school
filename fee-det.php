					...
					<!----start-top-nav---->
						...
						error_reporting(0);
							...
							<input type='hidden' value='<?php echo $password; ?>' name='pass'>
								...
								<li><a  href="sap" data-hover="Student Details">Student Details</a></li>
								<li><a  class="active" href="fee-det" data-hover="Fee Details">Fee Details</a></li>
								<li><a href="academic-det" data-hover="Academic Details">Academic Details</a></li>
								</form>
								<!---welcome user script-->
								<div class="user-menu">
								<p align="right">  <?php
...
<table id="travel" summary="Travel times to work by main mode (Autumn 2006) - Source: London Travel Report 2007 http://www.tfl.gov.uk/assets/downloads/corporate/London-Travel-Report-2007-final.pdf">
		...
		$query = "SELECT Amount, CurrencyKey, PaymentDate, ReferenceNumber, BankName, PaymentMode FROM fee1 WHERE RollNo = '$pass'";
    	...
    	<tr>
            ...
            <th scope="col" colspan="6"><center><b><font size="4">Fee Details</font></b></center></th>
        </tr>
		
        <tr>
            <th scope="col"><center>Amount</center></th>
            <th scope="col"><center>Currency Key</center></th>
            <th scope="col"><center>Payment Date</center></th>
            <th scope="col"><center>Reference Number</center></th>
            <th scope="col"><center>Bank Name</center></th>
            <th scope="col"><center>Payment Mode</center></th>
        </tr>  
	...
	<?PHP
    	...
    	<tr>
            ...
            <td><?PHP echo $row['CurrencyKey']; ?></td>
		...
		<?PHP } ?>		
											...
											<a href=#><p style="color:red;"><br> Generate Invoice </p></a>
