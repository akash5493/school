			...
			<div class="about-section">
				 <div class="container">
				     <div class="about-head">
							<h3>Students database Management System</h3>
							<p>--------------------------------------------------------------------------------------------------------------</p>
					 </div>
					 </div>
					 </div>
...
<center>
<form method='post' action='control-student_action.php'>
<table id="travel" summary="Travel times to work by main mode (Autumn 2006) - Source: London Travel Report 2007 http://www.tfl.gov.uk/assets/downloads/corporate/London-Travel-Report-2007-final.pdf">
    ...
    <thead>    
    	<tr>
            ...
            <th scope="col" colspan="9"><font size="4"><center><b>Student</b></center></font></th>
        </tr>
        
        <tr>
           
            <th scope="col"><center>Username</center></th>
            <th scope="col"><center>Rollno</center></th>
            <th scope="col"><center>RegistrationNo</center></th>
            <th scope="col"><center>Class</center></th>
            <th scope="col"><center>Address</center></th>
            <th scope="col"><center>Parent</center></th>
